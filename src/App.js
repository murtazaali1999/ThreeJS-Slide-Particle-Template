...
<Canvas dpr={[1, 1.5]} camera={{ position: [0, 0, 15] }} className="canvas-sticky">
    ...
    <div className='footer' color='white' align="center">
    <hr className='center'/>
    
    <div className='footer-left' color='white' align="center" >PranksterLabs</div>
    </div>
